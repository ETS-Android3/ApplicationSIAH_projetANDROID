...
public class menu_hb_arriere_tactique extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_hb_arriere_tactique);
        ImageView image1 = (ImageView) findViewById(R.id.imageschwenker);
        Button conseil1 = (Button) findViewById(R.id.btn_exo_1);
        ImageView image2 = (ImageView) findViewById(R.id.imagekungfu);
        ...
        Intent intent60 = new Intent(this, menu_hb_arriere.class);
