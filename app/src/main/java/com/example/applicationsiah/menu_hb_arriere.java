...
public class menu_hb_arriere extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_hb_arriere);
    ...
    private void visualiser_la_exogb() {
        Intent intent2 = new Intent(this, menu_hb_arriere_exo_spe.class);
        startActivity(intent2);
    }

    private void visualiser_la_tactiquegb() {
        Intent intent1 = new Intent(this, menu_hb_arriere_tactique.class);
