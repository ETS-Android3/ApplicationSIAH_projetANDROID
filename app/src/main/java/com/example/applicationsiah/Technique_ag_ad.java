...
public class Technique_ag_ad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_technique_ag_ad);
    ...
    private void retour() {
        Intent intent60 = new Intent(this, menu_foot_ad_ag.class);
